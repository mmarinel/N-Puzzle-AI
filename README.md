...
4. [Benchmarks](README.md#benchmarks)
5. [Appendix](README.md#appendix)
6. [Bibliography](README.md#bibliography)
...
You can find a sample of the benchmarks I performed on my puzzle solver inside the `test/benchmarks` subdirectory.

As shown in the `references` subfolder, solving puzzles of sizes greater than 4 can be unfeasable (Russell & Norvig + Richard Korf). Under the references folder indicated above, you can anyway find benchmarks on instances of those sizes that I was able to solve in reasonable time.
